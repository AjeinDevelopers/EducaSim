...
export default function HeaderApp() {
  return (
    <header>
        ...
        <Link className={""} to="/login_alumno"><Boton size = {"small"} Style={"secondary"} text={"Iniciar Sesión"} showIcon2={true} icon2={"fa-solid fa-right-to-bracket fa-fw"} handleClick={click}/></Link>
