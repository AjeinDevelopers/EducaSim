...
export default function Boton (props) {
    return(
        <button style={{...(props.plano ? {borderRadius: "0"} : {})}} className={props.disabled ? (props.size + " disabled") : (props.size + " " + props.Styke)} onClick={props.handleClick} formAction={props.action} formMethod={props.method} disabled={props.disabled}>
