...
export default function Ejercicio2(){
    ...
    /**repuestas correctas: 
     * Pregunta 1: {value: '4', label: '4/8'}
     * Pregunta 2: {value: '5', label: '1   '},
     * Pregunta 3: {value: '9', label: '6/8'}
     * Pregunta 4: {value: '13', label: '1/3'}
     * Pregunta 5: {value: '17', label: '8/10'}
    */
    const items = [
        {value: '1', label: ' 2/4'},
        {value: '2', label: '2/6'},
        ...
        <>
         ...
         <div style={{display:"flex", width:"1440px", padding:"var(--M, 48px) var(--XS, 32px)", flexDirection:"column", alignItems:"flex-start", gap:"var(--XS, 32px)"}}>
            <div style={{display:"flex", flexDirection:"column", alignItems:"center", gap:"var(--XXS, 24px)", alignSelf:"stretch"}}>
                <h2 className="secondary brand">Fracciones equivalentes y operaciones básicas
</h2>
                ...
                <RadButtonGroup items={items} size={"large"} estilo={"secondary"}
                                    label={"¿Cuál es una fracción equivalente a 1/2? "}
