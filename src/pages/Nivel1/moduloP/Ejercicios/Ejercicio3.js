...
export default function Ejercicio3(){
    ...
    /**repuestas correctas: 
     * Pregunta 1: {value: '1', label: '0.75'}
     * Pregunta 2: {value: '6', label: '1/3'},
     * Pregunta 3: {value: '7', label: '1/4'}
     * Pregunta 4:{value: '14', label: '0.7'}
     * Pregunta 5: {value: '17', label: '0.9'}
    */
    const items = [
        {value: '1', label: '0.75'},
        {value: '2', label: '0.5'},
        ...
        <>
         ...
         <div style={{display:"flex", width:"1440px", padding:"var(--M, 48px) var(--XS, 32px)", flexDirection:"column", alignItems:"flex-start", gap:"var(--XS, 32px)"}}>
            <div style={{display:"flex", flexDirection:"column", alignItems:"center", gap:"var(--XXS, 24px)", alignSelf:"stretch"}}>
                <h2 className="secondary brand">Decimales y su relación con fracciones
</h2>
                ...
                <RadButtonGroup items={items} size={"large"} estilo={"secondary"}
                                    label={"¿Cuál es el decimal equivalente a la fracción 3/4? "}
