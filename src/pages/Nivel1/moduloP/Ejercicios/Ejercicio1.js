...
export default function Ejercicio1(){
    ...
    /**repuestas correctas: 
     * Pregunta 1: {value: '2', label: '13,824'}
     * Pregunta 2: {value: '8', label: '500'}
     * Pregunta 3: {value: '11', label: '335,784'}
     * Pregunta 4: {value: '15', label: '383'}
     * Pregunta 5: {value: '19', label: '251'}
    */
    const items = [
