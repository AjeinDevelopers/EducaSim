    ...
    return(
        <>
            ...
            <div style={{display:"flex", width:"100%", height:"100%", justifyContent:"center", alignItems:"center"}}>
                <div style={{display:"flex", padding:"var(--XXXS, 16px) var(--M, 48px)", flexDirection:"column", alignItems:"flex-start", gap:"var(--XXXS, 16px)", alignSelf:"stretch"}}>
                    ...
                    <div style={{display:"flex", width:"100", flexDirection:"column", justifyContent:"center", alignItems:"center", gap:"var(--XXXS, 16px)"}}>
                        <div style={{display:"flex", width:"100%", flexDirection:"column", justifyContent:"center", alignItems:"center",alignSelf:"stretch", gap:"var(--XXXS, 16px)"}}>
                            ...
                            <NavLink className={''} to='/registro_Alum'><Boton size = {"small"} Style={"secondary"} text={"Registrarse"} showIcon2={true} icon2={"fa-solid fa-user-plus fa-fw"} /></NavLink>
                ...
                <div style={{display:"flex", padding:"var(--M, 48px) var(--XXS, 24px)",background:"var(--Color-Principales-Claros-Primary, #CAE6FF)" , flexDirection:"column", alignItems:"flex-start", width:"96%"}}>
                    ...
                    <Card direction={"vertical"} width={"416px"} header={"Aprendizaje Personalizado"} link={false} actions={false} adicional={false}
                     ...
                     <Card direction={"vertical"} width={"416px"} header={"Interactividad y Gamificación"} link={false} actions={false} adicional={false}
                     ...
                     <Card direction={"vertical"} width={"416px"} header={"Seguimiento y Reportes Detallados"} link={false} actions={false} adicional={false}
                ...
                <div style={{display:"flex", padding:"var(--M, 48px) var(--XXL, 80px)", flexDirection:"column", justifyContent:"center", alignItems:"center", gap:"var(--S, 36px)"}}>
                    <h3 className="secondary brand">¿Listo para impulsar la educación?</h3>
                    <div style={{alignSelf:"stretch"}}>
                    <t5>Con su enfoque en el aprendizaje personalizado, la interactividad y gamificación, y las herramientas avanzadas de seguimiento y reportes, EducaSim no solo mejora el rendimiento académico de los estudiantes, sino que también hace que el proceso de aprendizaje sea más atractivo y eficiente. </t5>
                    </div>
                    <div style={{display:"flex", padding:"var(--XUS, 8px) var(--XXXS, 16px)", alignItems:"center", gap:"var(--XXXS, 16px)" }}>
                    <Boton size = {"small"} Style={"secondary"} text={"Contáctanos"} showIcon1={true} icon1={"fa-solid fa-phone fa-fw"} />
                    </div>
