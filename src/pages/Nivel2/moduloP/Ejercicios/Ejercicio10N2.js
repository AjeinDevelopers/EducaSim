...
export default function Ejercicio10N2(){
     ...
     * Pregunta 3: {value: '171', label: '3/5'}
     * Pregunta 4: {value: '173', label: '1/2'}
     * Pregunta 5: {value: '177', label: '1/3'}
    */
    const items = [
        {value: '161', label: '1/4'},
        {value: '162', label: '3/8'},
        {value: '163', label: '3/16'}, 
        {value: '164', label: '1/2'}

    ];
    const items1 = [
        {value: '165', label: '6/12'},
        {value: '166', label: '8/12'},
        {value: '167', label: '8/15'}, 
        {value: '168', label: '10/15'}

    ];
    const items2 = [
        {value: '169', label: '1/2'},
        {value: '170', label: '3/10'},
        {value: '171', label: '3/5'},
        {value: '172', label: '4/5'}
        ...
        <>
         ...
         <div style={{display:"flex", width:"1440px", padding:"var(--M, 48px) var(--XS, 32px)", flexDirection:"column", alignItems:"flex-start", gap:"var(--XS, 32px)"}}>
            <div style={{display:"flex", flexDirection:"column", alignItems:"center", gap:"var(--XXS, 24px)", alignSelf:"stretch"}}>
                <h2 className="secondary brand">Fracciones básicas 2</h2>
